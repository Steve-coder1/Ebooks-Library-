...
# Keep strict transport defaults for production-like environments, but allow local HTTP development.
FORCE_HTTPS = os.getenv('DJANGO_FORCE_HTTPS', '0').lower() in ('1', 'true', 'yes')
SESSION_COOKIE_SECURE = not DEBUG or FORCE_HTTPS
CSRF_COOKIE_SECURE = not DEBUG or FORCE_HTTPS
SECURE_SSL_REDIRECT = not DEBUG or FORCE_HTTPS
...
SECURE_HSTS_SECONDS = 31536000 if (not DEBUG or FORCE_HTTPS) else 0
SECURE_HSTS_INCLUDE_SUBDOMAINS = not DEBUG or FORCE_HTTPS
SECURE_HSTS_PRELOAD = not DEBUG or FORCE_HTTPS
